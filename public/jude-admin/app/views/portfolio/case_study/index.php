                            ...
                            <div class="case-study-title">
                                <div class="case-study-title-top">
                                    ...
                                    <div class="col-100 case-study-header-details d-flex d-flex-row flex-justify-between">
                                        ...
                                        <img class="case-study-img col-50" src="'.$get_url.$projectData['project_img_directory'].$projectData['project_cover_img'].'" alt="project cover-image">
        ...
        if($section == 'project_show_reel')
        {
            echo '
                                        <div class="sectioners col-100 d-flex d-flex-row flex-align-start">
                                            <img src="'.$get_url.$projectData['project_img_directory'].$section_data.'" class="col-100" id="show_reeler" alt="showreel of project screens">
                                        </div>
                                    ';
