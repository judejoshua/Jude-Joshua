...
class Project extends Db
{
    ...
    {
        try {
            $query = "SELECT `id`, `unique_id`, `project_type`, `project_data`, `project_cover_img`, `project_year`, `project_img_directory` FROM `projects` WHERE `hidden` != '1' ORDER BY STR_TO_DATE(`projects`.`project_year`, '%M %Y') DESC";
