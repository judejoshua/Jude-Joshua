...
<html>
    <head>
        ...
        <link href="../../assets/css/verification.css" type="text/css" rel="stylesheet">
        ...
        <div class="wrapper">
            ...
            <div class="" id="body">
                ...
                <div class="container" id="booker_form">
                    <p>Fill enter driver's name in the form below to view driver's details...</p>
                    <form name="book" method="GET" action="">
                        <div class="form-group">
                            <input type="text" name="o_name" placeholder="Name">
                        </div>
                        <div class="form-group">
