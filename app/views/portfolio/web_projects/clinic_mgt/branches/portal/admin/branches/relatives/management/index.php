    ...
    <!DOCTYPE html>
        <html lang="en">
            <head>
                ...
                <title>Management - All staff</title>
                ...
                <div class="admin divwrap">
					...
					<div class="profilebody-left">
						<div class="profilebody-bottom-left">
							<h1 id="adminpage-title">All Staff</h1>
							<table>
								<?php
									$result = mysqli_query($db,"SELECT * FROM `management` ");
									if(mysqli_num_rows($result) > 0){
										...
										echo "
											<h3>There currently has not been any Staff added.</h3>
										";
									}
									mysqli_close($db);
								?>
