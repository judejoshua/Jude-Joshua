<?php
    ...
    if (mysqli_num_rows($confirmrows) < 2){
                        ...
                        <div class="profile-right">
                            ...
                            <div class="profilebody-left">
                                <div class="profilebody-bottom-left">
                                    <p id="view_error">
                                        Must have atleast one service defined. Click <a href="../">here</a> to go back.;
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        $sql = mysqli_query($db, "DELETE FROM `services_info` WHERE `id`='".$id."' ");
        if($sql){
            $reset = mysqli_query($db, "ALTER TABLE `services_info` AUTO_INCREMENT = 1");
            header('Location: ../');
        }
    }
?>