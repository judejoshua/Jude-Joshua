<?php
    ...
    $errors = array(); 
    $successes = array();
    $db = mysqli_connect('localhost:3306', 'root', '', 'cms');
    if(! $db ) {
    ...
    if (isset($_POST['create'])) {
        ...
        if($user){
            if ($user['name'] == $adminname) {
                array_push($errors, 'Sorry, '.$adminrole.'&#39;s name is already saved! <a href="https://ubyjude.bitbucket.io/clinic_mgt/branches/portal/admin/branches/relatives/management/" id="viewadmin">View</a>');
            };
            if ($user['email'] == $adminmail) {
                array_push($errors, 'Sorry, '.$adminrole.'&#39;s email is already saved! <a href="https://ubyjude.bitbucket.io/clinic_mgt/branches/portal/admin/branches/relatives/management/" id="viewadmin">View</a>');
            };
        };
