<?php
    ...
    if (!isset($_SESSION['adminid'])){
      ...
      $request_result = mysqli_query($db, "SELECT * FROM `requests` WHERE `new` = '1'");
      ...
      $req_result = mysqli_query($db, "SELECT * FROM `requests` ORDER BY updated desc");
                                            ...
                                            <table>
                                                <?php
                                                    if(mysqli_num_rows($req_result) > 0){
                                                        ...
                                                        ';
                                                        while($return = mysqli_fetch_array($req_result)){

                                                            $request = $return['additional info'];
                                                        ...
                                                        echo "
                                                            <h3>There currently has not been any requests sent yet.</h3>
                                                        ";
                                                    }
                                                    mysqli_close($db);
                                                ?>
