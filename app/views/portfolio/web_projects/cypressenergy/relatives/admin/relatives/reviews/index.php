<?php
    ...
    if (!isset($_SESSION['adminid'])){
      ...
      $rev_result = mysqli_query($db, "SELECT `name`, `review` FROM `reviews` ORDER BY updated desc");
                                                ...
                                                <?php
                                                    if(mysqli_num_rows($rev_result) > 0){
                                                        ...
                                                        while($return = mysqli_fetch_array($rev_result)){
                                                            ...
                                                            $reviews = $return['review'];
                                                            $review = base64_decode($reviews);
                                                        ...
                                                        echo "
                                                            <h3>There currently has not been any reviews sent yet.</h3>
                                                        ";
                                                    }
