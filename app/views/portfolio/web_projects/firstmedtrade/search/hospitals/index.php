    ...
    <body>
        <div id="mobile_navlinks">
            <div class="links">
                ...
                <a href="#" class="nav_active">Find Hospitals</a>
        ...
        <div class="divWrap">
            <div class="container" id="fhospitalshome">
                        ...
                        <div class="fill">
                            <div class="slider-form-padding">
                                <div class="slider-form">
                                    <h3>Find Hospitals and Make Referrals</h3>
                                    <form name="search" method="POST" action="">
                                        <div class="form-group">
                                            <input type="email" name="email_input" placeholder="Find by specialty or name.." maxlength="45" minlength="9">
                            ...
                            <div class="nav-pagination">
                                <a href="/">Home</a><span>/</span><a href="#" id="active">Find Hospitals</a>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="container" id="fhospitalsbody">
                <section id="success_story">
                    ...
                    <div class="success_box">
                        ...
                        <h5>Choose a Hospital</h5>
                    </div>
                    <div class="success_box">
                        <h3><i class="mdi mdi-airplane-takeoff"></i></h3>
                        <h5>Request a Referral</h5>
                    </div>
                    <div class="success_box">
                ...
                <section id="hospitals">
                    <div class="hospitals">
                        <div class="options">
                            <div id="options-body">
                                <h2>Looking for Doctors?<span>Gain access to search the best doctors and book appointments.</span></h2>
                                <a href="/search/doctors/" class="options-icon"><i class="mdi mdi-chevron-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <a href="#fhospitalshome" class="to-top">
